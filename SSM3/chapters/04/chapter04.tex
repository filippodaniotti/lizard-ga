...
\begin{document}
    ...
    \subsection{Sezione \songSec{A}}
    La sezione \songSec{A} è caratterizzata nella sua quasi totale interezza da un pedale di D. In \songSec{A}1 (Rg.\ref{sheet:sheep-a1_chords}), L'assolo di Rhodes fa ampio uso del Si naturale, dando alla sezione una forte impronta modale dorica.     
