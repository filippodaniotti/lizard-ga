...
\begin{document}
    ...
    Il Rhodes è il primo strumento ad entrare nel brano e, con un assolo di oltre un minuto e mezzo, assume il ruolo di voce principale della sezione \(\mathcal{A}1\). È eseguito su un Rhodes Mk1, dal timbro più scuro e morbido rispetto al Mk II e che ben si adatta all'atmosfera dalla calma cupa e alla dinamica contenuta della sezione. L'assolo è carico di una grande spontaneità, e il fraseggio è di carattere improvvisativo. Il sound engineer Brian Humphreis raccontò in seguito di aver intenzionalmente allontanato Waters dallo studio e aver spento le luci per creare un atmosfera soffusa, dando come unica indicazione a Wright la seguente frase: \gquotes{Rick, just do your thing.}\footnote{\gquotes{Rick, fai una delle tue solite cose.}}~\cite{easlea2022raving}.

    
    In effetti, l'impronta di Rick Wright è molto riconoscibile nel fraseggio: gli elementi principali sono lick blues, arpeggi e cluster di accordi. 
    ...
    \begin{sheet}[htbp]
        ...
        \caption[Progressione di accordi della sezione \(\mathcal{C}2\).]{Progressione di accordi della sezione \(\mathcal{C}2\). In evidenza la scala di Mi dorico eseguita dal sintetizzatore.}
